          ...
          <table class="table mytable">
            ...
            <tbody-->
              ...
              <div class="row rowBrd">
                ...
                <div class="col-lg-1 colBrd">  <a href="<?php echo base_url('residents/listOfResidents/'.$value->property) ?>">&nbsp;<i class="fa fa-pencil fa-2x text-primary" aria-hidden="true"></i></a><a href="#">&nbsp;<i class="fa fa-trash fa-2x text-danger" aria-hidden="true"></i></a></div>
