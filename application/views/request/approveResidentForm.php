        ...
        <div class="col-md-10">
          <table class="table text-left romtbl_borders">
            ...
            <h5 id="para">This is to confirm <?php echo $key->name;?> Id numbers <?php echo $key->identitynumber;?> 
              ...
              <h5 id="pari">You can go to  (<a href ="<?php echo base_url("Testing/index/") ?>">Confirm User Address</a>) to check the applicant  </h5>
            ...
            <div class="col-lg-12">
              ...
              <div class="col-lg-3">
                <button class="btn btn-md btn-primary form-control" name="approval"  type="submit" value="1">Approve</button>     
              </div>

              <div class="col-lg-3">
                <button class="btn btn-md btn-warning form-control" name="disapprove" type="submit" value="2">Decline</button>
              </div>
            </div>
          </div>
        </div>
